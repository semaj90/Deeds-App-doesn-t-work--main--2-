    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center space-x-2">
        ...
        <Dialog.Root bind:open={showSettingsDialog}>
          ...
          <Dialog.Content class="legal-card max-w-md">
            <Dialog.Header>
              <Dialog.Title class="legal-heading">AI Assistant Settings</Dialog.Title>
              <Dialog.Description class="text-legal-neutral text-sm">
...
<Dialog.Root bind:open={showCitationDialog}>
  <Dialog.Content class="legal-card max-w-lg">
    <Dialog.Header>
      <Dialog.Title class="legal-heading flex items-center">
