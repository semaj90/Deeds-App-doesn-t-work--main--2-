      ...
      <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div class="flex flex-col sm:flex-row gap-3">
          ...
          <div class="dropdown dropdown-end">
            <button tabindex="0" class="btn btn-outline" aria-label="Case actions">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <ul role="menu" tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
              <li><button type="button">Export All Cases</button></li>
              <li><button type="button">Import Cases</button></li>
              <li><button type="button">Generate Report</button></li>
              <li><hr></li>
              <li><button type="button">Archive Selected</button></li>
            </ul>
          </div>
        </div>
      </div>
        ...
        {#if showFilters}
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="form-control">
              ...
              <select id="status-filter" bind:value={statusFilter} class="select select-bordered focus:select-primary">
            ...
            <div class="form-control">
              ...
              <select id="sort-select" bind:value={sortBy} class="select select-bordered focus:select-primary">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {#each filteredCases as case_}
          <div 
            ...
            on:keydown={(e) => e.key === 'Enter' && goto(`/cases/${case_.id}`)}
