...
<div class="container mt-4 text-dark">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body text-center">                    {#if data.criminal.photoUrl}
                      <img src={data.criminal.photoUrl} alt="Criminal {data.criminal.firstName} {data.criminal.lastName}" class="img-fluid rounded mb-3" />
                    {:else}
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {:else if activeTab === 'evidence'}
                        <!-- Evidence section -->
                        <FileUploadSection criminalId={data.criminal.id} on:upload={() => { /* handle upload success */ }} />
