...
type LayoutRouteId = RouteId | "/" | "/ai" | "/ai-assistant" | "/bits-uno-demo" | "/cases" | "/cases/new" | "/cases/[id]" | "/dashboard" | "/demo" | "/editor" | "/evidence" | "/evidence/hash" | "/frameworks-demo" | "/interactive-canvas" | "/law" | "/local-ai-demo" | "/login" | "/logout" | "/original-home" | "/profile" | "/rag-demo" | "/register" | "/report-builder" | "/reports" | "/test-ai-ask" | "/test-gemma3" | "/ui-demo" | null
