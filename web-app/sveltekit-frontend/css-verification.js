...
const projectRoot = 'c:\\Users\\james\\Downloads\\Deeds-App-doesn-t-work--main (2)\\web-app\\sveltekit-frontend';
...
async function main() {
  ...
  await verifyFile(path.join(projectRoot, 'src/lib/components/HeadlessDemo.svelte'), 'Melt UI Demo');
