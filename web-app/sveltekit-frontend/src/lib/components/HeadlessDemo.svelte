...
<div class="headless-demo">
  <h2 class="text-2xl font-bold mb-4">Headless UI Components Demo</h2>
  ...
  <!-- Melt UI Dialog -->
  {#if $open}
    <div use:overlay class="dialog-overlay" transition:fade={{ duration: 150 }}>
      <div use:content class="dialog-content">
        <h3 use:dialogTitle class="dialog-title">
          Case Management System
        </h3>
        <p use:description class="dialog-description">
          This is a demo of Melt UI headless components integrated with PicoCSS styling and custom CSS variables.
        </p>
        
        <div class="dialog-actions">
          <button use:close class="btn btn-secondary">
            Cancel
          </button>
