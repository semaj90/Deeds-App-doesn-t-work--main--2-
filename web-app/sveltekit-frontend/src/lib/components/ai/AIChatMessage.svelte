...
<div class="chat-message {message.role}" role="article" aria-label="{message.role} message">
  <div class="message-header">
    ...
    <div class="message-actions">
      <span class="timestamp" title="Message sent at {new Date(message.timestamp).toLocaleString()}">
        {formattedTime}
      </span>
        ...
        {#if isMetadataExpanded}
          <div class="metadata-content" transition:slide={{duration: 200}}>
            ...
            <div class="metadata-item">
              ...
              <span class="value">{message.metadata.provider}</span>
            </div>
            <div class="metadata-item">
              <span class="label">Confidence:</span>
              <span class="value">{formatConfidence(message.metadata.confidence)}</span>
            </div>
            <div class="metadata-item">
              <span class="label">Response Time:</span>
              <span class="value">{formatExecutionTime(message.metadata.executionTime)}</span>
            </div>
