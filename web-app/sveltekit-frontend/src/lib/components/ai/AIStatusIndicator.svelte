...
<script lang="ts">
  ...
  // Provider details
  $: providerText = provider === 'local' ? 'Local AI' :
                    provider === 'cloud' ? 'Cloud AI' :
                    provider === 'hybrid' ? 'Hybrid AI' :
                    'No Provider';

  $: modelText = model || 'No Model';
</script>

<div class="ai-status-indicator" class:error class:loading class:ready={isReady}>
  <!-- Status Icon -->
  ...
  <div class="status-details">
    ...
    {#if isReady && provider && model}
      <div class="provider-info">
        <span class="provider" class:local={provider === 'local'}>
          {providerText}
        </span>
        <span class="separator">•</span>
        <span class="model" title="Current AI model: {model}">
          {modelText}
        </span>
      </div>
    {:else if error}
  ...
  <div class="status-tooltip">
    <div class="tooltip-content">
      ...
      {#if provider && model}
        <div class="tooltip-section">
          <strong>Provider:</strong> {providerText}
        </div>
        <div class="tooltip-section">
